...
??? info "Technical explanation"
    ...
    Since most of the requests to the AI Trading Bot API must be authenticated, a proper CORS policy is key to avoid security problems.
...
Assuming your application is deployed as `https://localhost:8080/home/` - this would mean that the following configuration becomes necessary:
