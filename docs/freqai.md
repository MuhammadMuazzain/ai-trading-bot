...
!!! Note
    FreqAI is, and always will be, a not-for-profit, open-source project. FreqAI does *not* have a crypto token, FreqAI does *not* sell signals, and FreqAI does not have a domain besides the present [ai-trading-bot documentation](https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/freqai/).
...
The normal AI Trading Bot install process will ask if you wish to install FreqAI dependencies. You should reply "yes" to this question if you wish to use FreqAI. If you did not reply yes, you can manually install these dependencies after the install with:
...
If you are using docker, a dedicated tag with FreqAI dependencies is available as `:freqai`. As such - you can replace the image line in your docker compose file with `image: ai_trading_botorg/ai_trading_bot:stable_freqai`. This image contains the regular FreqAI dependencies. Similar to native installs, Catboost will not be available on ARM based devices. If you would like to use PyTorch or Reinforcement learning, you should use the torch or RL tags, `image: ai_trading_botorg/ai_trading_bot:stable_freqaitorch`, `image: ai_trading_botorg/ai_trading_bot:stable_freqairl`.
...
You can find support for FreqAI in a variety of places, including the [project GitHub issues](https://github.com/MuhammadMuazzain/ai-trading-bot/issues), the dedicated [FreqAI discord](https://github.com/MuhammadMuazzain/ai-trading-bot/issues), and in [github issues](https://github.com/MuhammadMuazzain/ai-trading-bot/issues).
