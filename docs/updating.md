...
To update your ai-trading-bot installation, please use one of the below methods, corresponding to your installation method.
...
!!! Note "Legacy installations using the `master` image"
    We're switching from master to stable for the release Images - please adjust your docker-file and replace `ai_trading_botorg/ai_trading_bot:master` with `ai_trading_botorg/ai_trading_bot:stable`
