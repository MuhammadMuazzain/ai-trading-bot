...
This page provides you some basic concepts on how AI Trading Bot works and operates.

## AI Trading Bot terminology
...
All profit calculations of AI Trading Bot include fees. For Backtesting / Hyperopt / Dry-run modes, the exchange default fee is used (lowest tier on the exchange). For live operations, fees are used as applied by the exchange (this includes BNB rebates etc.).

## Pair naming

AI Trading Bot follows the [ccxt naming convention](https://docs.ccxt.com/#/README?id=consistency-of-base-and-quote-currencies) for currencies.
...
Starting ai-trading-bot in dry-run or live mode (using `ai-trading-bot trade`) will start the bot and start the bot iteration loop.
