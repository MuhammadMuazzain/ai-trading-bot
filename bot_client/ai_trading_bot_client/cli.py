...
from ai_trading_bot_client import __version__
from ai_trading_bot_client.api_client import RestApiClient
...
def add_arguments(args: Any = None):
    parser = argparse.ArgumentParser(
        prog="ai-trading-bot-client",
        description="Client for the ai-trading-bot REST API",
    )
    parser.add_argument(
