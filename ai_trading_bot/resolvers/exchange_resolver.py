...
import ai_trading_bot.exchange as exchanges
from ai_trading_bot.constants import Config, ExchangeConfig
from ai_trading_bot.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in ai_trading_bot.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("ai_trading_bot.", ""),
                    }
                )
        return result
