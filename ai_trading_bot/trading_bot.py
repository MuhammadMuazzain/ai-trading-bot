"""
AI Trading Bot is the main module of this bot. It contains the class AI Trading Bot()
"""
...
from ai_trading_bot.configuration import validate_config_consistency
from ai_trading_bot.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from ai_trading_bot.data.converter import order_book_to_dataframe
from ai_trading_bot.data.dataprovider import DataProvider
from ai_trading_bot.edge import Edge
...
from ai_trading_bot.exchange.exchange_types import CcxtOrder
from ai_trading_bot.leverage.liquidation_price import update_liquidation_prices
from ai_trading_bot.misc import safe_value_fallback, safe_value_fallback2
from ai_trading_bot.mixins import LoggingMixin
from ai_trading_bot.persistence import Order, PairLocks, Trade, init_db
from ai_trading_bot.persistence.key_value_store import set_startup_time
from ai_trading_bot.plugins.pairlistmanager import PairListManager
from ai_trading_bot.plugins.protectionmanager import ProtectionManager
from ai_trading_bot.resolvers import ExchangeResolver, StrategyResolver
from ai_trading_bot.rpc import RPCManager
from ai_trading_bot.rpc.external_message_consumer import ExternalMessageConsumer
from ai_trading_bot.rpc.rpc_types import (
    ProfitLossStr,
    RPCCancelMsg,
    RPCEntryMsg,
    RPCExitCancelMsg,
...
from ai_trading_bot.strategy.strategy_wrapper import strategy_safe_wrapper
from ai_trading_bot.util import FtPrecise, MeasureTime, PeriodicCache, dt_from_ts, dt_now
from ai_trading_bot.util.migrations.binance_mig import migrate_binance_futures_names
from ai_trading_bot.wallets import Wallets
...
class TradingBot(LoggingMixin):
    """
    AI Trading Bot is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before AI Trading Botbot has a chance to start its throttling,
        # so anything in the AI Trading Botbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, ai-trading-bot may try to recreate stoploss_on_exchange orders
    ...
    def handle_onexchange_order(self, trade: Trade) -> bool:
        ...
        try:
            ...
            # catching https://github.com/MuhammadMuazzain/ai-trading-bot/issues/9025
