...
from ai_trading_bot.configuration.deprecated_settings import process_temporary_deprecated_settings
from ai_trading_bot.configuration.directory_operations import create_datadir, create_userdata_dir
from ai_trading_bot.configuration.environment_vars import enironment_vars_to_dict
from ai_trading_bot.configuration.load_config import load_file, load_from_files
...
from ai_trading_bot.misc import deep_merge_dicts, parse_db_uri_for_logging, safe_value_fallback
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from ai_trading_bot.commands.arguments import NO_CONF_ALLOWED
        ...
        from ai_trading_bot.exchange.check_exchange import check_exchange
