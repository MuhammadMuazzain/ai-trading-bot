...
def ask_user_config() -> dict[str, Any]:
    ...
    from ai_trading_bot.exchange import available_exchanges
...
def deploy_new_config(config_path: Path, selections: dict[str, Any]) -> None:
    ...
    from ai_trading_bot.exchange import MAP_EXCHANGE_CHILDCLASS
    from ai_trading_bot.util import render_template
