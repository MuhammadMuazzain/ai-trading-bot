...
from ai_trading_bot.config_schema.config_schema import (
    CONF_SCHEMA,
...
from ai_trading_bot.configuration.deprecated_settings import process_deprecated_setting
from ai_trading_bot.constants import UNLIMITED_STAKE_AMOUNT
from ai_trading_bot.enums import RunMode, TradingMode
...
def _extend_validator(validator_class):
    """
    Extended validator for the AI Trading Bot configuration JSON Schema.
...
AI Trading BotValidator = _extend_validator(Draft4Validator)
...
def validate_config_schema(conf: dict[str, Any], preliminary: bool = False) -> dict[str, Any]:
    ...
    try:
        AI Trading BotValidator(conf_schema).validate(conf)
        return conf
