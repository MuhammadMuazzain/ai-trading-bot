...
from ai_trading_bot.strategy import IntParameter, IStrategy, merge_informative_pair  # noqa
...
class FreqaiExampleHybridStrategy(IStrategy):
    ...
    FreqAI to bolster a typical AI Trading Bot strategy.

    Launching this strategy would be:

    ai-trading-bot trade --strategy FreqaiExampleHybridStrategy --strategy-path ai_trading_bot/templates
