...
from ai_trading_bot.enums import RPCMessageType, RPCRequestType
from ai_trading_bot.exceptions import AI Trading BotException
from ai_trading_bot.rpc.api_server.api_auth import validate_ws_token
from ai_trading_bot.rpc.api_server.deps import get_message_stream, get_rpc
from ai_trading_bot.rpc.api_server.ws.channel import WebSocketChannel, create_channel
from ai_trading_bot.rpc.api_server.ws.message_stream import MessageStream
from ai_trading_bot.rpc.api_server.ws_schemas import (
    WSAnalyzedDFMessage,
    WSErrorMessage,
    WSMessageSchema,
    WSRequestSchema,
...
async def channel_reader(channel: WebSocketChannel, rpc: RPC):
    ...
    async for message in channel:
        ...
        except AI Trading BotException:
