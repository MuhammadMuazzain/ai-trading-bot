...
from ai_trading_bot.persistence import FtNoDBContext
from ai_trading_bot.rpc.api_server.api_pairlists import handleExchangePayload
from ai_trading_bot.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
from ai_trading_bot.rpc.api_server.deps import get_config, get_exchange
from ai_trading_bot.rpc.api_server.webserver_bgwork import ApiBG
from ai_trading_bot.util.progress_tracker import get_progress_tracker
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from ai_trading_bot.data.history.history_utils import download_data
