...
from ai_trading_bot.enums import NO_ECHO_MESSAGES, RPCMessageType
from ai_trading_bot.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, ai_trading_bot) -> None:
        ...
        self._rpc = RPC(ai_trading_bot)
        config = ai_trading_bot.config
        # Enable telegram
        if config.get("telegram", {}).get("enabled", False):
            logger.info("Enabling rpc.telegram ...")
            from ai_trading_bot.rpc.telegram import Telegram
