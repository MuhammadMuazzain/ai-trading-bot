...
from ai_trading_bot.constants import LAST_BT_RESULT_FN, IntOrInf
from ai_trading_bot.exceptions import ConfigurationError, OperationalException
from ai_trading_bot.ft_types import BacktestHistoryEntryType, BacktestResultType
from ai_trading_bot.misc import file_dump_json, json_load
from ai_trading_bot.optimize.backtest_caching import get_backtest_metadata_filename
from ai_trading_bot.persistence import LocalTrade, Trade, init_db
...
def analyze_trade_parallelism(results: pd.DataFrame, timeframe: str) -> pd.DataFrame:
    ...
    """
    from ai_trading_bot.exchange import timeframe_to_resample_freq
