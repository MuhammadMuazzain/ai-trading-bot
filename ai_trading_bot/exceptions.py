class AI Trading BotException(Exception):
    """
    AI Trading Bot base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(AI Trading BotException):
    """
...
class DependencyException(AI Trading BotException):
    """
...
class StrategyError(AI Trading BotException):
    """
