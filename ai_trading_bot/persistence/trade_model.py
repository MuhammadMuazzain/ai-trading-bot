...
from ai_trading_bot.enums import ExitType, TradingMode
...
from ai_trading_bot.leverage import interest
from ai_trading_bot.misc import safe_value_fallback
from ai_trading_bot.persistence.base import ModelBase, SessionType
from ai_trading_bot.persistence.custom_data import CustomDataWrapper, _CustomData
from ai_trading_bot.util import FtPrecise, dt_from_ts, dt_now, dt_ts, dt_ts_none
...
class LocalTrade:
    ...
    def calc_close_trade_value(self, rate: float, amount: float | None = None) -> float:
        ...
        if trading_mode == TradingMode.SPOT:
            ...
            raise OperationalException(
                f"{self.trading_mode} trading is not yet available using ai_trading_bot"
            )
