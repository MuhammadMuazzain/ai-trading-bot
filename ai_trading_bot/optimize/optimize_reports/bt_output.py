...
from ai_trading_bot.constants import UNLIMITED_STAKE_AMOUNT, Config
from ai_trading_bot.ft_types import BacktestResultType
from ai_trading_bot.optimize.optimize_reports.optimize_reports import generate_periodic_breakdown_stats
from ai_trading_bot.util import decimals_per_coin, fmt_coin, print_rich_table
...
def text_table_add_metrics(strat_results: dict) -> None:
    if len(strat_results["trades"]) > 0:
        ...
        # command stores these results and newer version of ai-trading-bot must be able to handle old
