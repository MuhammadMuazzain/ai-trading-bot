...
from ai_trading_bot.constants import FTHYPT_FILEVERSION, Config
from ai_trading_bot.enums import HyperoptState
from ai_trading_bot.exceptions import OperationalException
from ai_trading_bot.misc import deep_merge_dicts, round_dict, safe_value_fallback2
from ai_trading_bot.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get("is_best") is None:
                raise OperationalException(
                    ...
                    "of AI Trading Bot and cannot be loaded."
                )
