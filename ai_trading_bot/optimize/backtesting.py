...
from ai_trading_bot.configuration import TimeRange, validate_config_consistency
from ai_trading_bot.constants import DATETIME_PRINT_FORMAT, Config, IntOrInf, LongShort
from ai_trading_bot.data import history
from ai_trading_bot.data.btanalysis import find_existing_backtest_stats, trade_list_to_dataframe
from ai_trading_bot.data.converter import trim_dataframe, trim_dataframes
from ai_trading_bot.data.dataprovider import DataProvider
from ai_trading_bot.data.metrics import combined_dataframes_with_rel_mean
...
from ai_trading_bot.ft_types import (
    BacktestContentType,
...
from ai_trading_bot.optimize.backtest_caching import get_strategy_run_id
from ai_trading_bot.optimize.bt_progress import BTProgress
from ai_trading_bot.optimize.optimize_reports import (
...
from ai_trading_bot.persistence import (
    CustomDataWrapper,
    LocalTrade,
    Order,
    PairLocks,
...
from ai_trading_bot.util import FtPrecise, dt_now
from ai_trading_bot.util.migrations import migrate_data
...
class Backtesting:
    ...
    def __init__(self, config: Config, exchange: Exchange | None = None) -> None:
        ...
        if self.config.get("freqai_backtest_live_models", False):
            from ai_trading_bot.freqai.utils import get_timerange_backtest_live_models
    ...
    def _get_close_rate_for_roi(
        ...
        if roi is not None and roi_entry is not None:
            ...
            if trade_dur == 0 and (
                ...
                # details: https: // github.com/ai_trading_bot/ai_trading_bot/issues/6261
        ...
        if exit_.exit_flag:
            ...
            if exit_.exit_type in (
                ...
                if order_type == "limit":
                    ...
                    # ai-trading-bot does not support this in live, and the order would fill immediately
                    if trade.is_short:
    ...
    def get_valid_price_and_stake(
        ...
        if order_type == "limit":
            ...
            # which ai-trading-bot does not support in live.
