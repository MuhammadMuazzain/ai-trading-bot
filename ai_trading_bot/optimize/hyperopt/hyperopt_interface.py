...
from ai_trading_bot.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for ai-trading-bot hyperopt
    ...
    def roi_space(self) -> list[Dimension]:
        ...
        It's used by AI Trading Bot by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy AI Trading Bot roi_space()
