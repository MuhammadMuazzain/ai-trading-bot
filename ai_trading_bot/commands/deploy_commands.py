...
from ai_trading_bot.constants import USERPATH_STRATEGIES
...
def start_create_userdir(args: dict[str, Any]) -> None:
    ...
    :return: None
    """
    from ai_trading_bot.configuration.directory_operations import copy_sample_files, create_userdata_dir
...
def deploy_new_strategy(strategy_name: str, strategy_path: Path, subtemplate: str) -> None:
    ...
    """
    from ai_trading_bot.util import render_template, render_template_with_fallback
