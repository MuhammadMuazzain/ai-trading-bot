...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    from ai_trading_bot.exchange import list_available_exchanges
    from ai_trading_bot.ft_types import ValidExchangesType
    from ai_trading_bot.loggers.rich_console import get_rich_console
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for AI Trading Bot ({len(available_exchanges)} exchanges):"
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from ai_trading_bot.configuration import setup_utils_configuration
    from ai_trading_bot.exchange import market_is_active
    from ai_trading_bot.misc import plural, safe_value_fallback
    from ai_trading_bot.resolvers import ExchangeResolver
    from ai_trading_bot.util import print_rich_table
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from ai_trading_bot.configuration import setup_utils_configuration
    from ai_trading_bot.misc import parse_db_uri_for_logging
    from ai_trading_bot.persistence import Trade, init_db
