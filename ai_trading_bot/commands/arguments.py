...
from ai_trading_bot.commands.cli_options import AVAILABLE_CLI_OPTIONS
from ai_trading_bot.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="ai-trading-bot", description="Free, open source crypto trading bot"
        )
