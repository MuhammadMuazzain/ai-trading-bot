...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from ai_trading_bot.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting ai-trading-bot in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from ai_trading_bot.data.btanalysis import load_backtest_stats
    from ai_trading_bot.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting ai-trading-bot in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of ai-trading-bot Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help ai-trading-bot to exit
...
def start_edge(args: dict[str, Any]) -> None:
    ...
    :return: None
    """
    from ai_trading_bot.optimize.edge_cli import EdgeCli

    # Initialize configuration
    config = setup_optimize_configuration(args, RunMode.EDGE)
    logger.info("Starting ai-trading-bot in Edge mode")
...
def start_lookahead_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from ai_trading_bot.configuration import setup_utils_configuration
    from ai_trading_bot.optimize.analysis.lookahead_helpers import LookaheadAnalysisSubFunctions
...
def start_recursive_analysis(args: dict[str, Any]) -> None:
    ...
    """
    from ai_trading_bot.configuration import setup_utils_configuration
    from ai_trading_bot.optimize.analysis.recursive_helpers import RecursiveAnalysisSubFunctions
