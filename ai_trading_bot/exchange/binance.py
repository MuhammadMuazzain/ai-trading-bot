...
from ai_trading_bot.enums import CandleType, MarginMode, PriceType, TradingMode
from ai_trading_bot.exceptions import DDosProtection, OperationalException, TemporaryError
from ai_trading_bot.exchange import Exchange
from ai_trading_bot.exchange.binance_public_data import (
    concat_safe,
    download_archive_ohlcv,
    download_archive_trades,
)
from ai_trading_bot.exchange.common import retrier
from ai_trading_bot.exchange.exchange_types import FtHas, Tickers
from ai_trading_bot.exchange.exchange_utils_timeframe import timeframe_to_msecs
from ai_trading_bot.misc import deep_merge_dicts, json_load
from ai_trading_bot.util.datetime_helpers import dt_from_ts, dt_ts
...
class Binance(Exchange):
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by ai_trading_bot. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by ai_trading_bot. "
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/MuhammadMuazzain/ai-trading-bot/pull/5779#discussion_r740175931
