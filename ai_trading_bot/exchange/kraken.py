...
from ai_trading_bot.enums import MarginMode, TradingMode
...
from ai_trading_bot.exchange.exchange_types import CcxtBalances, FtHas, Tickers
...
class Kraken(Exchange):
    ...
    def calculate_funding_fees(
        ...
        """
        # ! This method will always error when run by AI Trading Bot because time_in_ratio is never
