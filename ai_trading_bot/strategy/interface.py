...
from ai_trading_bot.constants import CUSTOM_TAG_MAX_LENGTH, Config, IntOrInf, ListPairsWithTimeframes
from ai_trading_bot.data.converter import populate_dataframe_with_trades
from ai_trading_bot.data.converter.converter import reduce_dataframe_footprint
...
from ai_trading_bot.exceptions import OperationalException, StrategyError
from ai_trading_bot.exchange import timeframe_to_minutes, timeframe_to_next_date, timeframe_to_seconds
from ai_trading_bot.misc import remove_entry_exit_signals
from ai_trading_bot.persistence import Order, PairLocks, Trade
from ai_trading_bot.strategy.hyper import HyperStrategyMixin
from ai_trading_bot.strategy.informative_decorator import (
    InformativeData,
    PopulateIndicators,
...
from ai_trading_bot.util import dt_now
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for ai-trading-bot strategies
    ...
    def load_freqAI_model(self) -> None:
        if self.config.get("freqai", {}).get("enabled", False):
            ...
            from ai_trading_bot.freqai.utils import download_all_data_for_training
            from ai_trading_bot.resolvers.freqaimodel_resolver import FreqaiModelResolver
    ...
    def confirm_trade_entry(
        ...
        **kwargs,
        ...
        For full documentation please go to https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/strategy-advanced/
    ...
    def adjust_entry_price(
        ...
        **kwargs,
        ...
        For full documentation please go to https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/strategy-callbacks/
    ...
    def feature_engineering_expand_all(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/freqai-parameter-table/#feature-parameters

        https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/freqai-feature-engineering/#defining-the-features
    ...
    def feature_engineering_standard(
        ...
        *Only functional with FreqAI enabled strategies*
        ...
        https://github.com/MuhammadMuazzain/ai-trading-bot/en/latest/freqai-feature-engineering
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by ai-trading-bot itself, but intended to be used if users lock pairs
