...
from ai_trading_bot.constants import AVAILABLE_DATAHANDLERS
from ai_trading_bot.data.history.datahandlers.featherdatahandler import FeatherDataHandler
from ai_trading_bot.data.history.datahandlers.idatahandler import (
    IDataHandler,
    get_datahandler,
...
from ai_trading_bot.data.history.datahandlers.parquetdatahandler import ParquetDataHandler
...
def test_generic_datahandler_ohlcv_load_and_resave(
    ...
    mocker.patch(
        "ai_trading_bot.data.history.datahandlers.featherdatahandler.read_feather",
        side_effect=Exception("Test"),
    )
    mocker.patch(
        "ai_trading_bot.data.history.datahandlers.parquetdatahandler.read_parquet",
        side_effect=Exception("Test"),
    )
