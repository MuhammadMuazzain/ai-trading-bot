...
from ai_trading_bot.constants import DEFAULT_TRADES_COLUMNS
from ai_trading_bot.data.converter import populate_dataframe_with_trades
from ai_trading_bot.data.converter.orderflow import (
    ORDERFLOW_ADDED_COLUMNS,
    stacked_imbalance,
    timeframe_to_DateOffset,
    trades_to_volumeprofile_with_total_delta_bid_ask,
)
from ai_trading_bot.data.converter.trade_converter import trades_list_to_df
...
def test_analyze_with_orderflow(
    ...
    import ai_trading_bot.data.converter.orderflow as orderflow_module
