...
from ai_trading_bot.constants import BACKTEST_BREAKDOWNS, DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN
...
from ai_trading_bot.optimize.optimize_reports.bt_output import text_table_tags
from ai_trading_bot.optimize.optimize_reports.optimize_reports import (
    _get_resample_from_period,
    calc_streak,
    generate_tag_metrics,
)
from ai_trading_bot.resolvers.strategy_resolver import StrategyResolver
from ai_trading_bot.util import dt_ts
from ai_trading_bot.util.datetime_helpers import dt_from_ts, dt_utc
...
def test_store_backtest_results(testdatadir, mocker):
    dump_mock = mocker.patch("ai_trading_bot.optimize.optimize_reports.bt_storage.file_dump_json")
    zip_mock = mocker.patch("ai_trading_bot.optimize.optimize_reports.bt_storage.ZipFile")
