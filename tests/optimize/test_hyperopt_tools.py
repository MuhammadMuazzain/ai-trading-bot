...
from ai_trading_bot.constants import FTHYPT_FILEVERSION
from ai_trading_bot.exceptions import OperationalException
from ai_trading_bot.optimize.hyperopt_tools import HyperoptTools, hyperopt_serializer
...
def test_try_export_params(default_conf, tmp_path, caplog, mocker):
    ...
    default_conf["user_data_dir"] = tmp_path
    export_mock = mocker.patch("ai_trading_bot.optimize.hyperopt_tools.HyperoptTools.export_params")
