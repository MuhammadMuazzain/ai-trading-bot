...
from ai_trading_bot.optimize.hyperopt_loss.hyperopt_loss_short_trade_dur import ShortTradeDurHyperOptLoss
...
def test_hyperoptlossresolver(mocker, default_conf) -> None:
    ...
    mocker.patch(
        "ai_trading_bot.resolvers.hyperopt_resolver.HyperOptLossResolver.load_object",
