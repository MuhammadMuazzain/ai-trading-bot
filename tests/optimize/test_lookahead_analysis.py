...
from ai_trading_bot.commands.optimize_commands import start_lookahead_analysis
from ai_trading_bot.data.history import get_timerange
from ai_trading_bot.exceptions import OperationalException
from ai_trading_bot.optimize.analysis.lookahead import Analysis, LookaheadAnalysis
...
def test_start_lookahead_analysis(mocker):
    ...
    mocker.patch.multiple(
        "ai_trading_bot.optimize.analysis.lookahead_helpers.LookaheadAnalysisSubFunctions",
...
def test_lookahead_helper_text_table_lookahead_analysis_instances__caption(
    ...
    mocker.patch(
        "ai_trading_bot.optimize.analysis.lookahead_helpers.print_rich_table",
...
def test_initialize_single_lookahead_analysis(lookahead_conf, mocker, caplog):
    ...
    start_mock = mocker.patch("ai_trading_bot.optimize.analysis.lookahead.LookaheadAnalysis.start")
    strategy_obj = {
        "name": "strategy_test_v3_with_lookahead_bias",
        "location": Path(lookahead_conf["strategy_path"], f"{lookahead_conf['strategy']}.py"),
    }
