...
from ai_trading_bot.commands.optimize_commands import setup_optimize_configuration
...
from ai_trading_bot.enums.candletype import CandleType
...
def test_freqai_backtest_start_backtest_list(freqai_conf, mocker, testdatadir, caplog):
    ...
    mocker.patch("ai_trading_bot.optimize.backtesting.history.load_data")
    mocker.patch("ai_trading_bot.optimize.backtesting.history.get_timerange", return_value=(now, now))
...
def test_freqai_backtest_consistent_timerange(mocker, freqai_conf):
    ...
    gbs = mocker.patch("ai_trading_bot.optimize.backtesting.generate_backtest_stats")
