...
from ai_trading_bot.data.converter.trade_converter import trades_dict_to_list
from ai_trading_bot.enums import CandleType, MarginMode, TradingMode
from ai_trading_bot.exceptions import DependencyException, InvalidOrderException, OperationalException
from ai_trading_bot.exchange.exchange_utils_timeframe import timeframe_to_seconds
from ai_trading_bot.persistence import Trade
from ai_trading_bot.util.datetime_helpers import dt_from_ts, dt_ts, dt_utc
...
def patch_binance_vision_ohlcv(mocker, start, archive_end, api_end, timeframe):
    ...
    archive_mock = mocker.patch(
        "ai_trading_bot.exchange.binance.download_archive_ohlcv", side_effect=download_archive_ohlcv
    )
...
async def test__async_get_trade_history_id_binance_fast(
    ...
    pair = "ETH/BTC"
    mocker.patch(
        "ai_trading_bot.exchange.binance.download_archive_trades",
