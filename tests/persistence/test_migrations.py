...
from ai_trading_bot.constants import DEFAULT_DB_PROD_URL
...
from ai_trading_bot.persistence.base import ModelBase
from ai_trading_bot.persistence.migrations import get_last_sequence_ids, set_sequence_ids
...
def test_init_custom_db_url(default_conf, tmp_path):
    ...
    filename = tmp_path / "ai_trading_bot2_test.sqlite"
...
def test_init_prod_db(default_conf, mocker):
    ...
    create_engine_mock = mocker.patch("ai_trading_bot.persistence.models.create_engine", MagicMock())
...
def test_init_dryrun_db(default_conf, tmpdir):
    filename = f"{tmpdir}/ai_trading_bot2_prod.sqlite"
...
def test_migrate(mocker, default_conf, fee, caplog):
    ...
    mocker.patch("ai_trading_bot.persistence.models.create_engine", lambda *args, **kwargs: engine)
