...
from ai_trading_bot.constants import CUSTOM_TAG_MAX_LENGTH, DATETIME_PRINT_FORMAT
from ai_trading_bot.enums import TradingMode
from ai_trading_bot.exceptions import DependencyException
from ai_trading_bot.exchange.exchange_utils import TICK_SIZE
...
def test_update_order_from_ccxt(caplog, time_machine):
    ...
    # https://github.com/MuhammadMuazzain/ai-trading-bot/issues/5404
...
def test_recalc_trade_from_orders_kucoin():
    # Taken from https://github.com/MuhammadMuazzain/ai-trading-bot/issues/9346
