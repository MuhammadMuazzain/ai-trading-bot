...
from ai_trading_bot.data.history.history_utils import get_timerange
from ai_trading_bot.optimize.backtesting import Backtesting
from ai_trading_bot.persistence import Trade, disable_database_use, enable_database_use
...
def test_trade_custom_data_strategy_compat(mocker, default_conf_usdt, fee):
    ...
    mocker.patch("ai_trading_bot.trading_bot.TradingBot.get_real_amount", return_value=None)
    mocker.patch("ai_trading_bot.trading_bot.TradingBot.handle_cancel_exit", return_value=True)
    ...
    ai_trading_bot.strategy.custom_exit = custom_exit
    ff_spy = mocker.spy(ai_trading_bot.strategy, "custom_exit")
